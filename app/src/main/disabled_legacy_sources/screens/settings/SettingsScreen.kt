...
fun SettingsScreen(
    ...
    Scaffold(
        topBar = { SmartVisionTopBar("Settings", onBack = onBack) },
            ...
            Box(
                ...
                Row(
                    ...
                    Box(
                        Modifier
                            .size(56.dp)
                            .background(c.primary.copy(.15f), CircleShape)
                            .border(2.dp, c.primary.copy(.4f), CircleShape),
                        Alignment.Center
                    ) {
                        ...
                        AppTheme.entries.forEach { theme ->
                            ...
                            Column(
                                ...
                                Text(
                                    ...
                                    color = if (sel) accent else c.subtext,
                    ...
                    Row(
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                            listOf(3, 7, 14, 30).forEach { days ->
                                ...
                                Box(
                                    Modifier
                                        .background(if (sel) c.primary.copy(.2f) else c.surface, RoundedCornerShape(8.dp))
                                        .border(1.dp, if (sel) c.primary else c.border, RoundedCornerShape(8.dp))
                                        .clickable { vm.setAutoDelete(days) }
...
private fun InfoRow(icon: ImageVector, label: String, value: String) {
    ...
    Row(
        ...
        if (value.isNotEmpty()) {
            Text(value, style = MaterialTheme.typography.bodyMedium, color = c.subtext)
        } else {
            Icon(Icons.Rounded.ChevronRight, null, tint = c.subtext, modifier = Modifier.size(17.dp))
        }
    }
}
