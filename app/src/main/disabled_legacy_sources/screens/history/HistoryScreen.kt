...
private fun EmptyHistory(pad: PaddingValues) {
    ...
    Box(Modifier.fillMaxSize().padding(pad), Alignment.Center) {
        Column(
            ...
            Text("No scans yet", style = MaterialTheme.typography.headlineSmall, color = c.onSurface, fontWeight = FontWeight.SemiBold)
            Text("Your scan history will appear here.", style = MaterialTheme.typography.bodyMedium, color = c.subtext)
        }
    }
}
