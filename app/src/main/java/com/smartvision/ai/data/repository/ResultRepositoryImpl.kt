...
class ResultRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveToHistory(item: ScanHistoryItem): Result<Unit> {
        return try {
    ...
    override suspend fun getHistory(userId: String): Result<List<ScanHistoryItem>> {
        return try {
    ...
    override suspend fun deleteHistory(itemId: String): Result<Unit> {
        return try {
