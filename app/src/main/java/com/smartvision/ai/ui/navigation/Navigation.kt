...
object Routes {
    ...
    // Module routes derived from enum
    ...
    NavHost(
        ...
        composable(Routes.HOME) {
            HomeScreen(
                onModuleClick    = { module ->
                    // Modules that use camera go through CameraScreen
        ...
        composable(
            ...
            CameraScreen(
                ...
                onResult    = { navController.navigate(Routes.resultFor(moduleRoute)) {
                    popUpTo(Routes.HOME)
                }},
        ...
        composable(
            ...
            ResultScreen(
                moduleRoute = moduleRoute,
                onBack      = { navController.popBackStack() },
                onRescan    = { navController.navigate(Routes.cameraFor(moduleRoute)) {
                    popUpTo(Routes.HOME)
                }}
            )
        }
        ...
        composable(Routes.VOICE_TRANSLATOR) {
            TranslatorScreen(voiceMode = true, onBack = { navController.popBackStack() })
        }
        ...
        composable(Routes.HISTORY) {
            HistoryScreen(
                onBack      = { navController.popBackStack() },
                onItemClick = { historyId -> /* navigate to detail */ }
            )
        }
